...
class ShiPin:
    ...
    def get_pages(self, t_url):
        ...
        if self.page == 1:
            ...
            # 需要更改的代码
            for pn in range(98, self.pages + 1):
                # print('新一页')
                # 拼接分类页码网址
                page_url = 'http://www.58food.com/qy-l-0-0-3-0-%d.html' % pn
                print('数据获取中，第%s页' % pn)
                self.page += 1
    ...
    def save_data(self, dic):
        try:
            ...
            sql1 = """
                insert into xiuxianshipin (company, produce, company_type, name, phone, telephone, address, href) values (%s, %s, %s, %s, %s, %s, %s, %s);
                           """
...
if __name__ == '__main__':
    # 数据“”
    url = 'http://www.58food.com/qy-l-0-3.html'
    T = ShiPin()
    T(url)

...
# 数据条数小于40的网址
def page(small_url):
    company_html = get_url(small_url)
    num = company_html.xpath('//div[@class="main730"]/div/div[1]/span/em/text()')[0]
    num = int(num)
    # 循环num次
...
if __name__ == '__main__':
    # 切换省级分类网址
    type_url = 'https://b2b.huangye88.com/guangdong/mimian13476/'
    res = get_url2(type_url)

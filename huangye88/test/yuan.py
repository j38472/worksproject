...
def pages(page_url):
        ...
        for pn in range(1, page + 1):
            ...
            if pn == 1:
                ...
                company_url = page_url + 'pn%s' % pn
            res_page, html = get_url(company_url)
...
def save_data(data_list):
    ...
    # sql语句
    sql1 = """
        insert into zhejiang_shuiguoshucai (lianxiren, phone, telephone, company, produce, address, href) values (%s, %s, %s, %s, %s, %s, %s);
        """
...
if __name__ == '__main__':
    # 切换省级分类网址
    fenlei_url = 'https://b2b.huangye88.com/zhejiang/shuiguoshucai13583/'
    get_url2(fenlei_url)
